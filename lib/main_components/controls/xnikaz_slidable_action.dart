...
/// Signature for [XnikazSlidableAction.onPressed].
  ...
  Widget build(BuildContext context) {
    ...
    if (icon != null) {
      children.add(
        Icon(
          icon,
          size: iconSize ?? (kFontSizeFactor * 12),
